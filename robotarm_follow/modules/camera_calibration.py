...
class CameraCalibration:
    ...
    def __init__(self, calibration_file: str = "data/out.xls"):
        """
        初始化相机校准参数
    ...
    def _validate_camera_matrix(self) -> bool:
        """
        验证相机矩阵的有效性
    ...
    def rectify_images(self, left_img: np.ndarray, right_img: np.ndarray) -> Tuple[Optional[np.ndarray], Optional[np.ndarray]]:
        """
        对双目图像进行校正
